...
var VortexWatermarkOverlay = ({ className = "" }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex h-5 w-5 items-center justify-center rounded-md bg-sky-500/20 border border-sky-400/30 text-sky-400 shadow-[0_0_8px_rgba(56,189,248,0.3)]", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "svg",
          {
            viewBox: "0 0 24 24",
            fill: "none",
            ...
            className: "h-3 w-3",
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "m13 2-2 10 7-2-9 12 2-10-7 2z" })
          }
        ) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-baseline gap-1", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-xs font-bold tracking-tight text-white/80", children: "VorteX" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-[9px] font-semibold uppercase tracking-wider text-sky-400", children: "Charts" })
        ] })
      ]
    }
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        showWatermark && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(VortexWatermarkOverlay, {}),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        showWatermark && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(VortexWatermarkOverlay, {}),
...
var VortexConeChart = ({
  ...
  const bounds = (0, import_react3.useMemo)(() => {
    const prices = [];
  ...
  const priceLines = (0, import_react3.useMemo)(() => {
    const list = [];
    if (resolvedHigh > 0) {
      list.push({
        price: resolvedHigh,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        showWatermark && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(VortexWatermarkOverlay, {}),
