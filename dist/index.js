...
var VortexMultiLineChart = ({
  ...
  const hasRightAxis = useMemo13(() => {
    return normalizedSeries.some((s) => s.yAxis === "right");
  }, [normalizedSeries]);
  const { leftBounds, rightBounds, bounds } = useMemo13(() => {
    if (!hasRightAxis) {
      const allPrices = [];
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs15("div", { className: "flex items-center justify-between border-b border-white/10 pb-1", children: [
                /* @__PURE__ */ jsx15("span", { className: "text-zinc-400 font-semibold", children: activeLabel }),
                /* @__PURE__ */ jsx15("span", { className: "text-[10px] text-cyan-400 font-mono", children: "FLOW" })
              ] }),
              /* @__PURE__ */ jsx15("div", { className: "flex flex-col gap-1", children: normalizedSeries.map((s) => {
                ...
                return /* @__PURE__ */ jsxs15("div", { className: "flex items-center justify-between gap-4", children: [
                  /* @__PURE__ */ jsxs15("div", { className: "flex items-center gap-1.5", children: [
                    ...
                    /* @__PURE__ */ jsx15("span", { className: "text-zinc-300 text-[11px]", children: s.name })
                  ] }),
                  /* @__PURE__ */ jsx15("strong", { className: "text-white", children: formattedPrice })
                ] }, s.name);
              }) })
            ]
          }
  ...
  return /* @__PURE__ */ jsxs17(
    "div",
    {
      ...
      children: [
        ...
        hoveredCell && /* @__PURE__ */ jsxs17("div", { className: "pointer-events-none absolute top-2.5 right-3 z-20 flex items-center gap-2 rounded-lg border border-white/10 bg-black/85 px-3 py-1.5 text-[11px] backdrop-blur-md shadow-xl font-mono text-zinc-300", children: [
          /* @__PURE__ */ jsx17("span", { className: "text-white font-bold", children: data.yLabels[hoveredCell.row] || `Row ${hoveredCell.row + 1}` }),
          /* @__PURE__ */ jsx17("span", { className: "text-zinc-500", children: "\u2022" }),
          /* @__PURE__ */ jsx17("span", { className: "text-zinc-300 font-semibold", children: data.xLabels[hoveredCell.col] || `Col ${hoveredCell.col + 1}` }),
          /* @__PURE__ */ jsx17("span", { className: "text-zinc-500", children: ":" }),
          /* @__PURE__ */ jsx17("strong", { className: hoveredCell.val >= 0 ? "text-emerald-400" : "text-rose-400", children: formattedVal })
        ] })
      ]
    }
  );
...
var VortexWhaleBiasChart = ({
  ...
  const sortedBaseline = useMemo22(() => {
  ...
  const activeBaseline = useMemo22(() => {
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs24("div", { className: "mt-1.5 space-y-1 tabular-nums", children: [
                  ...
                  activeBaseline && /* @__PURE__ */ jsxs24("div", { className: "flex items-center justify-between text-[10px] text-zinc-400 border-t border-white/10 pt-1 mt-1", children: [
                    /* @__PURE__ */ jsx24("span", { children: "1D Cumulative:" }),
                    /* @__PURE__ */ jsxs24("span", { className: "text-zinc-300 font-semibold", children: [
...
import { useEffect as useEffect27, useMemo as useMemo23, useState as useState24 } from "react";
...
var VortexMultiAreaChart = ({
  ...
  const { containerRef, canvasRef, overlayRef, containerWidth } = useChartSurface();
  const [hoverIndex, setHoverIndex] = useState24(null);
  const [cursorPos, setCursorPos] = useState24(null);
  const bounds = useMemo23(() => {
    const allValues = [];
    series.forEach((s) => {
      s.data.forEach((d) => {
  ...
  return /* @__PURE__ */ jsxs25(
    "div",
    {
      ...
      style: { height },
      children: [
        /* @__PURE__ */ jsx25("div", { className: "absolute top-2.5 right-4 z-20 flex items-center gap-3 bg-black/60 px-3 py-1 rounded-full border border-white/10 backdrop-blur-md", children: series.map((s) => /* @__PURE__ */ jsxs25("div", { className: "flex items-center gap-1.5 text-xs", children: [
          /* @__PURE__ */ jsx25(
            "span",
            {
              className: "h-2 w-2 rounded-full",
          ...
          /* @__PURE__ */ jsx25("span", { className: "text-zinc-300 font-mono text-[11px]", children: s.name })
        ] }, s.name)) }),
        /* @__PURE__ */ jsx25(
          "canvas",
          {
        ...
        /* @__PURE__ */ jsx25("canvas", { ref: overlayRef, className: "pointer-events-none absolute inset-0 block" }),
        hoverIndex !== null && cursorPos && /* @__PURE__ */ jsxs25(
          "div",
          {
            className: "pointer-events-none absolute z-30 flex flex-col gap-1.5 rounded-xl border border-cyan-500/30 bg-[#020616]/90 px-3.5 py-2.5 text-xs backdrop-blur-xl shadow-2xl font-mono text-zinc-300",
            style: {
            ...
            children: [
              /* @__PURE__ */ jsxs25("div", { className: "flex items-center justify-between border-b border-white/10 pb-1", children: [
                /* @__PURE__ */ jsx25("span", { className: "text-zinc-400 font-semibold", children: activeLabel }),
                /* @__PURE__ */ jsx25("span", { className: "text-[10px] text-cyan-400 font-mono", children: "0DTE FLOW" })
              ] }),
              /* @__PURE__ */ jsx25("div", { className: "flex flex-col gap-1", children: series.map((s) => {
                const item = s.data[hoverIndex];
                if (item === void 0) return null;
                const val = typeof item === "number" ? item : item.y;
                const formattedVal = formatValue ? formatValue(val) : `$${formatPrice(val)}`;
                return /* @__PURE__ */ jsxs25("div", { className: "flex items-center justify-between gap-4", children: [
                  /* @__PURE__ */ jsxs25("div", { className: "flex items-center gap-1.5", children: [
                    /* @__PURE__ */ jsx25("span", { className: "h-1.5 w-1.5 rounded-full", style: { backgroundColor: s.color } }),
                    /* @__PURE__ */ jsx25("span", { className: "text-zinc-300 text-[11px]", children: s.name })
                  ] }),
                  /* @__PURE__ */ jsx25("strong", { className: "text-white", children: formattedVal })
                ] }, s.name);
              }) })
            ]
          }
...
var VortexGauge = ({
  ...
  return /* @__PURE__ */ jsx26(
    "div",
    {
      ...
      style: { height },
      children: /* @__PURE__ */ jsx26("canvas", { ref: canvasRef, className: "block w-full h-full" })
    }
  );
};
export {
